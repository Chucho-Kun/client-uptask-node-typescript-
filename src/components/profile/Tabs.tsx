...
export default function Tabs() {
    ...
    return (
        <div className='mb-10'>
            <div className="sm:hidden bg-white pr-4 rounded-md cursor-pointer">
                ...
                <select
                    id="tabs"
                    name="tabs"
                    className="block w-full rounded-md border-gray-300 focus:border-purple-800 focus:ring-purple-800 p-4"
